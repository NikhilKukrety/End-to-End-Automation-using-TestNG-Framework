...
public class AbstractComponent {
	...
	//Method to click on "Order" link on the header:
	public OrderPage goToOrdersPage()
	{
		orderHeader.click();
		OrderPage orderPage = new OrderPage(driver); //Creating object for the next page "CartPage"
		return orderPage;
	}
